...
const DATASETS = {
  ...
  brands: {
    electronics: ["Apple","Sony","Panasonic","Nintendo","Canon","Nikon","CASIO","Seiko","Citizen","ASUS","Dell","HP","Lenovo"],
    fashion:     ["Nike","Adidas","Uniqlo","GU","ZARA","Supreme","The North Face","Levi's","Rolex","OMEGA"],
    hobby:       ["Bandai","Kotobukiya","Good Smile","SEGA","Takara Tomy"],
    home:        ["IKEA","Nitori","T-fal","Iris Ohyama","Yamazen"]
  },
  // 全国＋都道府県（抜粋＋主要）—必要に応じて拡張可能
...
function onQuickDeadlineClick(e){
  ...
  qs("#deadline-input").value = toDatetimeLocalValue(target);
}
